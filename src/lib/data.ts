...
export const HEROES: Hero[] = [
  ...
  { id: 'medusa', name: 'Medusa', hp: 16, move: 3, attack: 'RANGED', set: 'Battle of Legends, Volume One', sidekicks: [{ name: 'Harpies', count: 3, hp: 5, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/T-A4wGqLFywPYo2WgIj6Tg__imagepage/img/N_D8_OFSbT6BNbXuFnuxu_2AiE4=/fit-in/900x600/filters:no_upscale():strip_icc()/pic5609982.png' },
  ...
  { id: 'robin-hood', name: 'Robin Hood', hp: 13, move: 2, attack: 'RANGED', set: 'Robin Hood vs Bigfoot', sidekicks: [{ name: 'Outlaws', count: 4, hp: 4, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/Y3lCu-ZE4VZ6sBZw_W4-Gw__imagepage/img/rvXYSvM2cqCWzGxBnYJ0n7kvjvI=/fit-in/900x600/filters:no_upscale():strip_icc()/pic4830611.png' },
  { id: 'ingen', name: 'Robert Muldoon', hp: 14, move: 3, attack: 'RANGED', set: 'Jurassic Park – InGen vs. Raptors', sidekicks: [{ name: 'Ingen Workers', count: 3, hp: 5, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/8zf7IKj82FQB1t-nnGOV4A__imagepage/img/lzYNLMVVrW4UtzCz1QWbYUGpRoo=/fit-in/900x600/filters:no_upscale():strip_icc()/pic5652033.png' },
  ...
  { id: 'sherlock-holmes', name: 'Sherlock Holmes', hp: 16, move: 2, attack: 'MELEE', set: 'Cobble & Fog', sidekicks: [{ name: 'Dr. Watson', count: 1, hp: 10, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/IqIEU9H73W8p5Pzbe1vprA__imagepage/img/q4bBVeVlC-YVhaNGf0J2RO0XbXo=/fit-in/900x600/filters:no_upscale():strip_icc()/pic5182960.png' },
  { id: 'dracula', name: 'Dracula', hp: 13, move: 2, attack: 'MELEE', set: 'Cobble & Fog', sidekicks: [{ name: 'The Sisters', count: 3, hp: 6, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/uj-PHVY0R0SL6SbJzm8t6Q__imagepage/img/HI2LYtzjkIkCy2TGx1HjRfxRvsc=/fit-in/900x600/filters:no_upscale():strip_icc()/pic5182952.png' },
  ...
  { id: 'luke-cage', name: 'Luke Cage', hp: 13, move: 2, attack: 'MELEE', set: 'Redemption Row', sidekicks: [{ name: 'Misty Knight', count: 1, hp: 9, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/vPtSEYtO2mjsjFCNsHRbtw__imagepage/img/90Q4pSz3Hxa0JPB48A_eNpfF6V4=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6093967.png' },
  ...
  { id: 'elektra', name: 'Elektra', hp: 7, move: 2, attack: 'MELEE', set: 'Hell\'s Kitchen', sidekicks: [{ name: 'The Hand', count: 4, hp: 3, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/uGqLsF_EtTUdEEyDo4x60A__imagepage/img/lS6Ud6r9cqpNlnQFrU4dHgGUOmY=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6093947.png' },
  ...
  { id: 'houdini', name: 'Harry Houdini', hp: 14, move: 2, attack: 'MELEE', set: 'Houdini vs. The Genie', sidekicks: [{ name: 'Bess', count: 1, hp: 9, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/M6CpbIThDSa5nqCUxOp9yQ__imagepage/img/pRNMiLTJD_aFhWcbLJwKEjHAGGw=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257642.png' },
  ...
  { id: 'hamlet', name: 'Hamlet', hp: 15, move: 2, attack: 'MELEE', set: 'Slings & Arrows', sidekicks: [{ name: 'Rosencrantz & Guildenstern', count: 2, hp: 7, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/N5WU_kJZpx6cJjlNj7P2iw__imagepage/img/PzXbJDXpALZxsE5gDdGIHiYEAa0=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257640.png' },
  ...
  { id: 'eredin', name: 'Eredin', hp: 14, move: 2, attack: 'MELEE', set: 'The Witcher – Realms Fall', sidekicks: [{ name: 'Red Riders', count: 4, hp: 4, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/Tn8ZukZMb9ZOYPjB-Cm4iQ__imagepage/img/TLtTLKLGW_2CpT-ySt7z8L76aZs=/fit-in/900x600/filters:no_upscale():strip_icc()/pic7775193.png' },
  { id: 'philippa', name: 'Philippa', hp: 12, move: 2, attack: 'RANGED', set: 'The Witcher – Realms Fall', sidekicks: [{ name: 'Dijkstra', count: 1, hp: 9, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/y-5o6E3bT9Oaa8j8BnQj6Q__imagepage/img/l2ER3BEshxUc7pOe-mTa75xYfdo=/fit-in/900x600/filters:no_upscale():strip_icc()/pic7775196.png' },
