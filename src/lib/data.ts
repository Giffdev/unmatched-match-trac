...
export const HEROES: Hero[] = [
  ...
  { id: 'the-genie', name: 'The Genie', hp: 16, move: 3, attack: 'RANGED', set: 'Houdini vs. The Genie', sidekicks: [{ name: 'Camels', count: 3, hp: 6, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/B7pSMbIz2fVjO85FvkCLKw__imagepage/img/dC4fWYnc5cj4tXKNGdrhWajoCYc=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257644.png' },
  ...
  { id: 'nikola-tesla', name: 'Nikola Tesla', hp: 14, move: 2, attack: 'RANGED', set: 'Adventures: Tales to Amaze', sidekicks: [{ name: 'Pigeons', count: 2, hp: 5, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/v8j8U3bvKOuNj72UajZBag__imagepage/img/NujPG15-JCQxRXqHsqb0VljsSO0=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257652.png' },
