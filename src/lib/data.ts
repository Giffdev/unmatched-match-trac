...
export const UNMATCHED_SETS: SetInfo[] = [
  ...
  { name: 'Stars and Stripes', franchise: 'Unmatched' },
]
...
export const HEROES: Hero[] = [
  ...
  { id: 'angel', name: 'Angel', hp: 16, move: 2, attack: 'MELEE', set: 'Buffy the Vampire Slayer', sidekicks: [{ name: 'Faith', count: 1, hp: 8, attack: 'MELEE' }], imageUrl: AngelImg, abilityDescription: "After Angel or Faith attacks, if you lost the combat, draw 1 card." },
  ...
  { id: 'medusa', name: 'Medusa', hp: 16, move: 3, attack: 'RANGED', set: 'Battle of Legends, Volume One', sidekicks: [{ name: 'Harpies', count: 3, hp: 1, attack: 'MELEE' }], imageUrl: MedusaImg, abilityDescription: "At the start of your turn, you may deal 1 damage to an opposing fighter in Medusa's zone." },
  { id: 'king-arthur', name: 'King Arthur', hp: 18, move: 2, attack: 'MELEE', set: 'Battle of Legends, Volume One', sidekicks: [{ name: 'Merlin', count: 1, hp: 7, attack: 'RANGED' }], imageUrl: KingArthurImg, abilityDescription: "When King Arthur attacks, you may BOOST that attack. Play the BOOST card, face down, along with your attack card. If your opponent cancels the effects on your attack card, the BOOST is discarded without effect." },
  ...
  { id: 'sun-wukong', name: 'Sun Wukong', hp: 17, move: 2, attack: 'MELEE', set: 'Battle of Legends, Volume Two', sidekicks: [{ name: 'Clones', count: 3, hp: 1, attack: 'MELEE' }], imageUrl: SunWukongImg, abilityDescription: "At the start of your turn, you may take 1 damage to summon a Clone in an empty space adjacent to Sun Wukong. Do not start with any Clones on the board." },
  ...
  { id: 'squirrel-girl', name: 'Squirrel Girl', hp: 13, move: 2, attack: 'MELEE', set: 'Teen Spirit', sidekicks: [{ name: 'Squirrels', count: 8, hp: 1, attack: 'MELEE' }], imageUrl: SquirrelGirlImg, abilityTitle: "GO NUTS!", abilityDescription: "At the start of your turn, summon a squirrel in a space adjacent to Squirrel Girl. Squirrels are small fighters. Do not start with any squirrels on the board." },
