...
export const HEROES: Hero[] = [
  ...
  { id: 'sinbad', name: 'Sinbad', hp: 15, move: 2, attack: 'MELEE', set: 'Battle of Legends, Volume One', sidekicks: [{ name: 'The Porter', count: 1, hp: 9, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/7hKRE5V_3gVRtcbcWB3Ucw__imagepage/img/v68q5IZCGtYVZk6A9BmP1bN4lj4=/fit-in/900x600/filters:no_upscale():strip_icc()/pic5609986.png' },
  ...
  { id: 'spike', name: 'Spike', hp: 15, move: 2, attack: 'MELEE', set: 'Buffy the Vampire Slayer', sidekicks: [{ name: 'Drusilla', count: 1, hp: 9, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/VxQo_ZywuMJ4EWBAtc6zQA__imagepage/img/7F-9c7fKIUF1vKo-YrQ5LOxBvtg=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6093889.png' },
  { id: 'willow', name: 'Willow', hp: 14, move: 2, attack: 'RANGED', set: 'Buffy the Vampire Slayer', sidekicks: [{ name: 'Tara', count: 1, hp: 9, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/5yfLH_gg7fXj32xKr9_yIQ__imagepage/img/a7mjF-7fCLRAqKRADHVNDYJV0ng=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6093893.png' },
  ...
  { id: 'sun-wukong', name: 'Sun Wukong', hp: 17, move: 2, attack: 'MELEE', set: 'Battle of Legends, Volume Two', sidekicks: [{ name: 'Clones', count: 3, hp: 4, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/OkGx7fXRrF_-l7BPZ6_e_A__imagepage/img/KH2ixWxYaV-5TLfJ_CBQGDVL7jw=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257625.png' },
  { id: 'yennenga', name: 'Yennenga', hp: 15, move: 2, attack: 'RANGED', set: 'Battle of Legends, Volume Two', sidekicks: [{ name: 'Archers', count: 2, hp: 6, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/NqnlJR48tDFVqcUAe5wKWw__imagepage/img/S9p-9fqbFbbApF0v0lK-uNvP-rU=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257627.png' },
  ...
  { id: 'titania', name: 'Titania', hp: 12, move: 2, attack: 'RANGED', set: 'Slings & Arrows', sidekicks: [{ name: 'Oberon', count: 1, hp: 9, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/BoevOvNBOw2eZFj0u-tJrg__imagepage/img/00eHQOOSNaGWvhNpkr1gmlKmr-4=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257661.png' },
