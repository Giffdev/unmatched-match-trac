...
export const HEROES: Hero[] = [
  ...
  { id: 'ancient-leshen', name: 'Ancient Leshen', hp: 13, move: 1, attack: 'RANGED', set: 'The Witcher – Steel & Silver', sidekicks: [{ name: 'Wolves', count: 2, hp: 1, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/VFbI8rCPBG-qp39Px8QhGQ__imagepage/img/8oI5VuFdqj0i4rI_olB_QJ18mL4=/fit-in/900x600/filters:no_upscale():strip_icc()/pic7775202.png' },
  ...
  { id: 'doctor-strange', name: 'Doctor Strange', hp: 14, move: 2, attack: 'RANGED', set: 'Brains and Brawn', sidekicks: [{ name: 'Wong', count: 1, hp: 6, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/fKC-e_cZ1q5VG_X2qP0f1g__imagepage/img/RgEXKdO1uBJ4ygXQQ4eMSU7k0w8=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6093945.png' },
  ...
  { id: 'dr-jill-trent', name: 'Dr. Jill Trent', hp: 13, move: 2, attack: 'MELEE', set: 'Adventures: Tales to Amaze', sidekicks: [{ name: 'Daisy', count: 1, hp: 6, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/Ppa3hELSoxjUNpwQrTIUTQ__imagepage/img/a59fvIf3l_YhZ5kZgFzYz9GqDMg=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257636.png' },
  
  { id: 'medusa', name: 'Medusa', hp: 16, move: 3, attack: 'RANGED', set: 'Battle of Legends, Volume One', sidekicks: [{ name: 'Harpies', count: 3, hp: 2, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/T-A4wGqLFywPYo2WgIj6Tg__imagepage/img/N_D8_OFSbT6BNbXuFnuxu_2AiE4=/fit-in/900x600/filters:no_upscale():strip_icc()/pic5609982.png' },
  { id: 'king-arthur', name: 'King Arthur', hp: 18, move: 2, attack: 'MELEE', set: 'Battle of Legends, Volume One', sidekicks: [{ name: 'Merlin', count: 1, hp: 6, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/6VoqcPdHxKNu2wQEbIr3GA__imagepage/img/X-YQJieCsE7Jn-RGIEELyRTzEag=/fit-in/900x600/filters:no_upscale():strip_icc()/pic5609977.png' },
  ...
  { id: 'robin-hood', name: 'Robin Hood', hp: 13, move: 2, attack: 'RANGED', set: 'Robin Hood vs Bigfoot', sidekicks: [{ name: 'Outlaws', count: 4, hp: 1, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/Y3lCu-ZE4VZ6sBZw_W4-Gw__imagepage/img/rvXYSvM2cqCWzGxBnYJ0n7kvjvI=/fit-in/900x600/filters:no_upscale():strip_icc()/pic4830611.png' },
  { id: 'ingen', name: 'Robert Muldoon', hp: 14, move: 3, attack: 'RANGED', set: 'Jurassic Park – InGen vs. Raptors', sidekicks: [{ name: 'Ingen Workers', count: 3, hp: 2, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/8zf7IKj82FQB1t-nnGOV4A__imagepage/img/lzYNLMVVrW4UtzCz1QWbYUGpRoo=/fit-in/900x600/filters:no_upscale():strip_icc()/pic5652033.png' },
  ...
  { id: 'dracula', name: 'Dracula', hp: 13, move: 2, attack: 'MELEE', set: 'Cobble & Fog', sidekicks: [{ name: 'The Sisters', count: 3, hp: 2, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/uj-PHVY0R0SL6SbJzm8t6Q__imagepage/img/HI2LYtzjkIkCy2TGx1HjRfxRvsc=/fit-in/900x600/filters:no_upscale():strip_icc()/pic5182952.png' },
  ...
  { id: 'sun-wukong', name: 'Sun Wukong', hp: 17, move: 2, attack: 'MELEE', set: 'Battle of Legends, Volume Two', sidekicks: [{ name: 'Clones', count: 3, hp: 2, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/OkGx7fXRrF_-l7BPZ6_e_A__imagepage/img/KH2ixWxYaV-5TLfJ_CBQGDVL7jw=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257625.png' },
  { id: 'yennenga', name: 'Yennenga', hp: 15, move: 2, attack: 'RANGED', set: 'Battle of Legends, Volume Two', sidekicks: [{ name: 'Archers', count: 2, hp: 3, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/NqnlJR48tDFVqcUAe5wKWw__imagepage/img/S9p-9fqbFbbApF0v0lK-uNvP-rU=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257627.png' },
  ...
  { id: 'elektra', name: 'Elektra', hp: 7, move: 2, attack: 'MELEE', set: 'Hell\'s Kitchen', sidekicks: [{ name: 'The Hand', count: 4, hp: 1, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/uGqLsF_EtTUdEEyDo4x60A__imagepage/img/lS6Ud6r9cqpNlnQFrU4dHgGUOmY=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6093947.png' },
  ...
  { id: 'the-genie', name: 'The Genie', hp: 16, move: 3, attack: 'RANGED', set: 'Houdini vs. The Genie', sidekicks: [{ name: 'Camels', count: 3, hp: 2, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/B7pSMbIz2fVjO85FvkCLKw__imagepage/img/dC4fWYnc5cj4tXKNGdrhWajoCYc=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257644.png' },
  ...
  { id: 'winter-soldier', name: 'Winter Soldier', hp: 15, move: 2, attack: 'RANGED', set: 'For King and Country', sidekicks: [{ name: 'Hydra Soldier', count: 2, hp: 3, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/nF_zLfAL0tDzwLN78IlDgA__imagepage/img/JnZBONLbZF6iEWI8nW3OFn5kdoE=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6093991.png' },
  { id: 'spider-man', name: 'Spider‑Man', hp: 15, move: 3, attack: 'MELEE', set: 'Brains and Brawn', sidekicks: [{ name: 'Aunt May', count: 1, hp: 5, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/HqSJ6zFyEi4ifnqQHpgOaw__imagepage/img/H7zMM_o3Ee8OJbVD9qNg1Hg1BYk=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6093983.png' },
  { id: 'she-hulk', name: 'She‑Hulk', hp: 20, move: 2, attack: 'MELEE', set: 'Brains and Brawn', sidekicks: [{ name: 'Pug', count: 1, hp: 5, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/I9QHsRbN8cRkz-cSjKOkYA__imagepage/img/gXSXVq8jq3sxJlHcHEG6-_5KhqM=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6093977.png' },
  { id: 'nikola-tesla', name: 'Nikola Tesla', hp: 14, move: 2, attack: 'RANGED', set: 'Adventures: Tales to Amaze', sidekicks: [{ name: 'Pigeons', count: 2, hp: 2, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/v8j8U3bvKOuNj72UajZBag__imagepage/img/NujPG15-JCQxRXqHsqb0VljsSO0=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257652.png' },
  { id: 'golden-bat', name: 'Golden Bat', hp: 18, move: 3, attack: 'MELEE', set: 'Adventures: Tales to Amaze', sidekicks: [{ name: 'Takeru', count: 1, hp: 7, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/E4iMhN1Lp3gUz_X46_Mkmw__imagepage/img/d6JTIpM0WiQyqLiDivCIqj1qgNo=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257638.png' },
  { id: 'tomoe-gozen', name: 'Tomoe Gozen', hp: 14, move: 2, attack: 'RANGED', set: 'Sun\'s Origin', sidekicks: [{ name: 'Kaiso', count: 1, hp: 7, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/eHGrh8aQdtKNJjg7eYYs8g__imagepage/img/x6cBNs2h2CzLvUxkTW9Oq-8n48M=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257659.png' },
  { id: 'oda-nobunaga', name: 'Oda Nobunaga', hp: 13, move: 2, attack: 'MELEE', set: 'Sun\'s Origin', sidekicks: [{ name: 'Honor Guard', count: 2, hp: 3, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/EabM2FdC2WiQKQKECe-5xw__imagepage/img/Dy75XCazBF0vIaU2FHubZJOh6Uw=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257654.png' },
  { id: 'hamlet', name: 'Hamlet', hp: 15, move: 2, attack: 'MELEE', set: 'Slings & Arrows', sidekicks: [{ name: 'Rosencrantz & Guildenstern', count: 2, hp: 3, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/N5WU_kJZpx6cJjlNj7P2iw__imagepage/img/PzXbJDXpALZxsE5gDdGIHiYEAa0=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257640.png' },
  ...
  { id: 'william-shakespeare', name: 'William Shakespeare', hp: 13, move: 2, attack: 'MELEE', set: 'Slings & Arrows', sidekicks: [{ name: 'Actors', count: 3, hp: 2, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/eSsb82XCOEu2gIjSKE-Xxw__imagepage/img/7fgJVkJ4Qh3r5cWH4d9z1V2bJC0=/fit-in/900x600/filters:no_upscale():strip_icc()/pic6257668.png' },
  { id: 'eredin', name: 'Eredin', hp: 14, move: 2, attack: 'MELEE', set: 'The Witcher – Realms Fall', sidekicks: [{ name: 'Red Riders', count: 4, hp: 1, attack: 'MELEE' }], imageUrl: 'https://cf.geekdo-images.com/Tn8ZukZMb9ZOYPjB-Cm4iQ__imagepage/img/TLtTLKLGW_2CpT-ySt7z8L76aZs=/fit-in/900x600/filters:no_upscale():strip_icc()/pic7775193.png' },
  ...
  { id: 'yennefer-triss', name: 'Yennefer & Triss', hp: 14, move: 2, attack: 'RANGED', set: 'The Witcher – Realms Fall', sidekicks: [{ name: 'Triss', count: 1, hp: 6, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/hLHEdyiO7kVqP2R8BnJBZA__imagepage/img/f9kbmXAI9MG7xhtZnCdUFxeZOVM=/fit-in/900x600/filters:no_upscale():strip_icc()/pic7775200.png' },
  { id: 'geralt', name: 'Geralt of Rivia', hp: 16, move: 2, attack: 'MELEE', set: 'The Witcher – Steel & Silver', sidekicks: [{ name: 'Dandelion', count: 1, hp: 5, attack: 'RANGED' }], imageUrl: 'https://cf.geekdo-images.com/s9GF0fXi-P4xjKKQd7YpXw__imagepage/img/7NVe-H0Jz55tcrnREK6h_QJdvvM=/fit-in/900x600/filters:no_upscale():strip_icc()/pic7775208.png' },
